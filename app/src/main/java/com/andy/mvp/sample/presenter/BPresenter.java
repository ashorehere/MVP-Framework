...
public class BPresenter extends BasePresenter<BView> {
    /**
     * Play 获取网络数据
     * @param params 参数
     */
    public void getDataPlay(String params){
        if (!isViewAttached()){
            //如果没有View引用就不加载数据
            return;
        }
     ...
     * @param params 参数
     */
    public void getDataStop(String params){
        if (!isViewAttached()){
            //如果没有View引用就不加载数据
            return;
        }
